...
model{
  ...
  for (i in 1:N) {
    ...
    # 3. Outcome model
    y[i] ~ dbern(y_p[i])
    logit(y_p[i]) <-  beta_0_0 + beta_x_0 * x[i] + inprod(beta_z_0, z[i, ])
  }
  ...
  #inits# lambda_0_0, phi_0_0, gamma_0_0, gamma_z_0, beta_0_0, beta_x_0, beta_z_0, gamma_0_j, tau_gamma_0_j, lambda_0_j, tau_lambda_0_j, phi_0_j, tau_phi_0_j
}
